    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{' '}
          <Link to="/signup" className="font-medium text-[--color-ninjaOrange] hover:text-orange-600">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-3 border border-gray-300 rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[--color-ninjaOrange] focus:border-transparent transition-all duration-200"
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to="/forgot-password" className="font-medium text-[--color-ninjaOrange] hover:text-orange-600">
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-xl text-white bg-[--color-ninjaOrange] hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[--color-ninjaOrange] transition-all duration-200 transform hover:scale-105 shadow-lg"
              >
                Sign in
              </button>
            </div>
